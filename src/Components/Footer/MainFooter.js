        ...
        <div className="row mt-3">
          ...
          <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <hr
                ...
                />
            <p>
            <span className='h1'>W</span>e are the only E-Medical Service
             in Bangladesh to follow the Guidelines for Good E-Medical Service 
             Practice principles. Following our mission to provide 
             patient centric service, we also offer counseling service to our
             patients regarding the medicines and medication practice.
            </p>
          </div>
...
<NavLink  className='link' style={{fontWeight: "bold", fontSize:'20px',color:"gray"}}
    ...
    <section
             ...
             style={{backgroundColor:"rgb(68, 67, 70)"}}     
             >
